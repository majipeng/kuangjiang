...
-- ----------------------------
 DROP TABLE IF EXISTS `dcw_auth_rule`;
CREATE TABLE `dcw_auth_rule` (
...
-- ----------------------------
 DROP TABLE IF EXISTS `dcw_auth_group`;
CREATE TABLE `dcw_auth_group` (
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, 
...
-- ----------------------------
-- dcw_auth_group_access 用户组明细表
-- uid:用户id，group_id：用户组id
-- ----------------------------
DROP TABLE IF EXISTS `dcw_auth_group_access`;
CREATE TABLE `dcw_auth_group_access` (
