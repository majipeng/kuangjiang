<?php /*a:2:{s:71:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\auth\authgroup.html";i:1604480545;s:70:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\public\header.html";i:1604456926;}*/ ?>
<!doctype html>
...
layui.use(['laydate','form','jquery', 'upload','table'], function(){
    ...
    table.render({
        elem: '#demo'
        ,id:'table'
        ,url: '<?php echo url("auth/grouplist"); ?>' //数据接口
        ,title: '角色组'
        ,page: true //开启分页
    ...
    table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
        ...
        if(layEvent === 'edit'){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '600px'],
                content:['<?php echo url("Auth/groupedit"); ?>?id='+data.id]
            });
        }
        if(layEvent === 'del'){
            layer.confirm('真的删除行么', function(index){
                $.ajax({
                    type: "POST",
                    url: "<?php echo url('Auth/groupdel'); ?>",
                    data: {id:data.id},
                    dataType: "json",
