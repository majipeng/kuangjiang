<?php /*a:2:{s:67:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\user\index.html";i:1604480147;s:70:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\public\header.html";i:1604456926;}*/ ?>
<!doctype html>
                ...
                <div class="layui-card-body ">
                    <script type="text/html" id="toolbarDemo">
                        <div class="layui-btn-container">
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('添加用户','add',700,600)">添加用户</button>
                        </div>
                    </script>
...
layui.use(['laydate','form','jquery', 'upload','table'], function(){
    ...
    table.render({
        elem: '#demo'
        ,id:'table'
        ,url: '<?php echo url("User/userlist"); ?>' //数据接口
        ,title: '用户表'
        ,page: true //开启分页
    ...
    table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
        ...
        if(layEvent === 'edit'){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '600px'],
                content:['<?php echo url("User/edit"); ?>?id='+data.id, 'no']
            });
        }
