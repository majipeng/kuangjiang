<?php /*a:2:{s:71:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\auth\groupedit.html";i:1604468592;s:70:"F:\phpstudy_pro\WWW\www.kuangjia.com\app\admin\view\public\header.html";i:1604456926;}*/ ?>
<!doctype html>
        ...
        <div class="layui-row">
            <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <input type="text" id="title"  autocomplete="off" class="layui-input" placeholder="请输入标题" value="<?php echo htmlentities($title); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="name" class="layui-form-label">
...
layui.config({
    ...
    $(".layui-btn").on("click",function() {
      ...
      $.ajax({
           type: "POST",
           url: "<?php echo url('Auth/groupedit'); ?>?id=<?php echo htmlentities($id); ?>",
